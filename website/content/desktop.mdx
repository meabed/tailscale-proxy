...
Needs Go 1.26+ and a C toolchain (Xcode CLT on macOS; `libgtk-4-dev` +
`libwebkitgtk-6.0-dev` on Linux). See [`desktop/README.md`](https://github.com/meabed/tailscale-proxy/blob/master/desktop/README.md).
